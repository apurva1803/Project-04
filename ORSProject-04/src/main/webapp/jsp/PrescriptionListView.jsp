...
<%@page import="in.co.rays.proj4.controller.PrescriptionListCtl"%>
...
<body>
    ...
    <div align="center">
        ...
        <h1 align="center" style="margin-bottom: -15; color: navy;">Prescription List</h1>
        ...
        <form action="<%=ORSView.PRESCRIPTION_LIST_CTL%>" method="POST">
            <%
                ...
                List<PrescriptionBean> list = (List<PrescriptionBean>) ServletUtility.getList(request);
            ...
            <table border="1" style="width: 100%; border: groove;">
                ...
                <tr>
                    ...
                    <td style="text-align: center; text-transform: capitalize;"><%=bean.getMedicines()%></td>
                                       <td style="text-align: center; text-transform: capitalize;"><%=bean.getStatus()%></td>
                                               
                    <td style="text-align: center;"><a href="PrescriptionCtl?id=<%=bean.getId()%>">Edit</a></td>
                </tr>
                <%
                    }
                %>
            ...
            <table style="width: 100%">
                <tr>
                    <td style="width: 25%">
                        <input type="submit" name="operation" value="<%=PrescriptionListCtl.OP_PREVIOUS%>" <%=pageNo > 1 ? "" : "disabled"%>>
                    </td>
                    <td align="center" style="width: 25%">
                        <input type="submit" name="operation" value="<%=PrescriptionListCtl.OP_NEW%>">
                    </td>
                    <td align="center" style="width: 25%">
                        <input type="submit" name="operation" value="<%=PrescriptionListCtl.OP_DELETE%>">
                    </td>
                    <td style="width: 25%" align="right">
                        <input type="submit" name="operation" value="<%=PrescriptionListCtl.OP_NEXT%>" <%= (nextPageSize != 0) ? "" : "disabled" %>>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td align="right">
                        <input type="submit" name="operation" value="<%=PrescriptionListCtl.OP_BACK%>">
                    </td>
                </tr>
            </table>
            <%
